...
public class Pizza {
   ...
   private  int basePrice; // different for veg and non veg

   private  int toppingPrice; // different for veg and non veg, added on extra topping

   private int cheesePrice = 80; // same for both, added if customer wants extra cheese

   private int bagPrice = 20; // added if
